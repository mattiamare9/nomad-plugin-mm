...
```sh
git clone https://github.com/mattiamare9/nomad-plugin-mm.git
cd nomad-plugin-mm
...
```sh
pip install dist/nomad-plugin-mm-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Mattia Marella | [mattia.marella@edu.unife.it](mailto:mattia.marella@edu.unife.it)
